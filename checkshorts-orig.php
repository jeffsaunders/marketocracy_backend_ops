...
echo '
<strong><h2>The following is a list of all "short" positions in active members\' funds as of '.date('m/d/y @ h:i A (T)').':</h2><br></strong>
';
...
if ($emptyReport){
	echo "<h2>No 'shorts' found.</h2>";
}else{
	echo'
</table>
<strong><h2>'.$shortsCnt.' short'.($shortsCnt > 1 ? 's' : '').' found.</h2></strong>
	';
}
