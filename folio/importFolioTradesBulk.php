<?php
// This script extracts the daily trades from a bulk FOLIOfn feed and imports them into the folio trade history table.
// This is run as needed when a bulk file is provided.  Essentially, it imports all rows in a file, not just those for a specific date like the CRON process does.
// The filename must be edited at line 41 below
// *Note - this will not run within a web browser.
// Written by: Jeff Saunders 5/30/18
// Modified by: Jeff Saunders - 8/15/18 - Created this special version of importFolioTrades for bulk imports
...
//$filename = "marketocracy-report-2018-06-26.csv";
$filename = "foo";
