<?php
/*
This include processes the returned XML for the spinoffsOnDate method (CAProcessing API).
Called from daemons/includes/resultsProcessing.php

Example source:
<results>
   <method>spinoffsOnDate</method>
...
//print_r($aOneAction);
									...
									$terms		= $aOneAction->terms;
									$stock		= $aOneAction->spinoffStock;
