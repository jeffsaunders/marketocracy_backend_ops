<?php
/*
This include processes the returned XML for the symbolChangesOnDate method (CAProcessing API).
Called from daemons/includes/resultsProcessing.php

Example source:
<results>
   <method>symbolChangesOnDate</method>
   <trans_ID>999</trans_ID>
   <date>20151102</date>
   <actions>
      <oneAction>
         <symbol>KTDRE</symbol>
         <newSymbol>KTDR</newSymbol>
      </oneAction>
      <oneAction>
         <symbol>MULT</symbol>
         <newSymbol>MAUI</newSymbol>
      </oneAction>
   </actions>
</results>
*/
...
//									$company_id	= $aOneAction->companyID;// Use ours instead
									$newSymbol	= $aOneAction->newSymbol;
