<?php
//$stock_corporate_actions_table = "stock_corporate_actions_JEFF";
/*
This include processes the returned XML for the delistingsOnDate method (CAProcessing API).
Called from daemons/includes/resultsProcessing.php

Example source:
<results>
   <method>listingsOnDate</method>
   <trans_ID>1</trans_ID>
   <date>20151102</date>
   <actions>
      <oneAction>
