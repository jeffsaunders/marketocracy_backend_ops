<?php
/*
This include processes the returned XML for the stockDividendsOnDate method (CAProcessing API).
Called from daemons/includes/resultsProcessing.php

Example source:
<results>
   <method>stockDividendsOnDate</method>
   ...
   <actions>
      <oneAction>
         ...
         <dividendStock>LIIHF</dividendStock>
      </oneAction>
   </actions>
</results>
*/
...
//print_r($aOneAction);
									...
									$amount		= $aOneAction->amount;
									$stock		= $aOneAction->dividendStock;
									...
									$query = "
										...
										AND dividendStock 	= :dividendStock
										AND method			= :method
									";
									try{
