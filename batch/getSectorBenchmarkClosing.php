<?php
/*
The purpose of this script is to get the daily closing prices of the sector benchmark funds (SPDRs) from AlphaVantage using JSON and writes them into the stocks_benchmarks_history table.
...
foreach ($aSymbols as $symbol){
	...
	// e.g. Array([Information] => Thank you for using Alpha Vantage! Please visit https://www.alphavantage.co/premium/ if you would like to have a higher API call volume.)
