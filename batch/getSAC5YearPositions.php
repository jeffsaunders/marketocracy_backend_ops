<?php
// This commandline batch script generates API quries to pull in the positions for each specified fund on the first day of each month for the past 5 years.
