<?php
// This script adds the first and last name of the tracked managers to a temporary list of funds tracked in portfolio by fund_id.
...
while($tracker = $rsTrackers->fetch(PDO::FETCH_ASSOC)){
	...
	$managers_list = substr($managers_list, 0, -1);
