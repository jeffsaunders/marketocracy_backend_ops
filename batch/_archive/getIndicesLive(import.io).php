...
// Russell 3000
$aIndex[5][0] = "https://api.import.io/store/connector/7d7a7761-c435-4751-94d7-2e244f33efd3/_query?input=webpage/url:https%3A%2F%2Fwww.google.com%2Ffinance%3Fq%3DRUA%26ei%3DgPADV8G1A4PvmAH5ybuADw&&_apikey=cc4cd938daf04872aaa2eb4916a0eecbecad128d20e54b2843e8c5e01afd3dda8febb90d0b3c62a58f83bc31eb7acac6cde0a1fc385b7d89dba9b84113dc504c4e72df9052779f87ea8e67d66077dd36";
$aIndex[5][1] = "index_rua";
$aIndex[5][2] = "RUA";
$aIndex[5][3] = "^RUA";
...
$aIndex[6][2] = "S&amp;P";
$aIndex[6][3] = "^SP500TR";  //SPXTR

// Grab "yesterday's" closing prices
for ($x = 0; $x < sizeof($aIndex); $x++){
		...
		while ($closePrice = $rsClosePrice->fetch(PDO::FETCH_ASSOC)){
			if (date('z', $closePrice['unix_date']) == date('z')){
				continue;
			}

			// Add closing price to array
			$aIndex[$x][4]	= $closePrice['close'];
			break;
		}
}
...
//echo isMarketOpen(time(), $linkID, "indices");
...
//			$indexDirection	= substr( $index->change, 0, 1);
			...
			$indexChange = $indexPrice - $aIndex[$indexCounter][4];
...
//			$percentChange = number_format(round(($indexChange/$indexPrice)*100, 2), 2);
			...
			if ($indexChange == 0){
				...
				$percentChange = $direction.abs($percentChange)."%";
			}
...
//			}
			...
			// 15 minute delay
//			$indexTime = date('M j g:i:s A T', time() - 15 * 60);
