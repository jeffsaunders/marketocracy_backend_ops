<?php
/*
The purpose of this script is to populate the rank_raw_nav table with the raw NAV data file produced monthly for Ken's own rankings system.
...
/////////NEED TO MAKE THIS A PASSED VALUE////////////////////////////
...
//echo strtotime($aNAV['AsOfDate'])."\n";die();
	...
	// If we don;t have this member in Nova, then just skip them.
	if ($member_id == ""){
		continue;
	}
