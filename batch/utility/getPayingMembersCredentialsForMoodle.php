<?php
/*
The purpose of this script is to build a file of login credentials for all Plus and Pro members for importation into Moodle
...
$fp1 = fopen("/var/www/html/tmp/PayingMembersCredentialsForMoodle.csv", "w");
