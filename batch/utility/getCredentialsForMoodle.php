<?php
/*
The purpose of this script is to build a file of login credentials for all managers for importation into Moodle
...
$fp1 = fopen("/var/www/html/tmp/CredentialsForMoodle.csv", "w");
